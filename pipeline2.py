...
def main() -> None:
    ...
    measurements = [{'measurement_ID'  : 'ABAB_3',
                     'chip_IDs'         : ['25286', '25327'],
                     'trials'           : ['A_1', 'B_1', 'A_2', 'B_2']}]
    ...
    for measurement in measurements:
        ...
        for chip_id in measurement['chip_IDs']:
            for trial in measurement['trials']:
                ...
                output_file = f'C:\\Users\\bow-lab\\Documents\\Code\\results\\ABAB\\{id}\\results_{chip_id}\\results_{trial}_dt0002.pkl'
                print(f'output_file:\n {output_file}')
